...
<section class="md:mx-20 lg:mx-40 xl:mx-60 mt-10">
	...
	<article class="md:grid md:grid-cols-2 mb-20 md:mb-40">
		...
		<p>
			...
			purchaseflow on Skolemad.dk. <strong>OBS!</strong> The whole site is not clickable: The task was
			only to design and develop pages relevant to the purchaseflow.
		</p>
	</article>
