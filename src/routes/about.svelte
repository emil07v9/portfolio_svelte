	...
	<article class="slide-in-bottom-side">
		...
		<div class="grid grid-cols-2">
			<p class="pt-2">
				...
				Erhvervsakademi. Lorem ipsum dolor sit amet consectetur adipisicing elit. Impedit nesciunt
				accusantium dolore quasi rem excepturi facilis rerum error doloremque labore. Fuga ipsum
				earum saepe ab doloribus similique dolores praesentium atque neque aperiam nostrum rerum
				excepturi, minus soluta! Dicta, eaque explicabo!
			</p>
			<img src="" alt="" />
		</div>
	</article>
